...
export const CATEGORY_META = {
  ...
  'Credit Card': { emoji: '💳', tile: '#f1ebfc' },
  Education: { emoji: '📚', tile: '#e8f0fe' },
  'Common Fee': { emoji: '🏢', tile: '#e7f4ec' },
  Vehicle: { emoji: '🚗', tile: '#fbeede' },
  Insurance: { emoji: '🛡️', tile: '#e3f3ec' },
  Donate: { emoji: '🤝', tile: '#e8f4ec' },
  Family: { emoji: '👨‍👩‍👧', tile: '#fef3e8' },
  Saving: { emoji: '🐷', tile: '#e0f0ff' },
  'Freelance': { emoji: '💼', tile: '#e8f0fe' },
  'Business': { emoji: '🏢', tile: '#f1ebfc' },
  'Investment': { emoji: '📈', tile: '#e3f3ec' },
  'Bonus': { emoji: '⭐', tile: '#fef9e3' },
  'Rental': { emoji: '🏠', tile: '#e7f4ec' },
  'Gift': { emoji: '🎁', tile: '#fdecef' },
